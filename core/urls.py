...
from .views import CourseViewSet, OfficeViewSet, StudentViewSet, MenuItemViewSet, home, course_list, register, contact, student_dashboard, student_login, admin_dashboard, student_profile_edit, student_password_reset_request, student_password_reset_confirm, student_verify_email, admin_export_students, student_certificate_download
