"""
Django settings for alkeatech project.
...
SECRET_KEY = 'django-insecure-x0g&*1gxgt8hr)%ddw^2r36pxi4(15cs(b#d2yh=t(emp6m57c'
...
WSGI_APPLICATION = 'alkeatech.wsgi.application'
